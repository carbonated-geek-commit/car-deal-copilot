...
2026-08-07 12:50 · fixer · verifier finding resolved: renamed package.json marker "@adapters/valuation" → "@deal-copilot/adapters-valuation" per ADR-004 (imports/aliases untouched — tests import via tsconfig alias, not npm name); re-ran vitest (55/55 green) + tsc --noEmit (green); note: docs/design/T-003.md §1 line 35 still shows the old name — design doc is designer-owned, correction deferred to designer
