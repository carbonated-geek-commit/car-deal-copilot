...
undefined · integrator · ADR-005 applied (D1 resolved: core amendment landed, fallback collapsed to `export type ExtractedOffer = Offer;`; type-level tests updated to assert identity with @core Offer; 52/52 green, tsc green; stage remains validate)
