...
2026-08-07 12:49 · fixer · fixed unknown-kind bypass in memory-store.ts validateInput (`in` → typeof string guard + Object.hasOwn(CHANNEL_BY_KIND, input.kind)); packages/receipt 37/37 pass, full suite 391 pass / 1 skipped (nhtsa live-smoke, intentional)
