...
undefined · integrator · ADR-005 applied (core Offer.sale_price now optional `sale_price?: MoneyCents` — absent = dealer did not state a price; no core test asserted required-ness, 82/82 still green)
